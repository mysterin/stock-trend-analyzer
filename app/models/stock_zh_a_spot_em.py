...
class StockZhASpotEm(Base):
    ...
    change_percentage: Mapped[Optional[decimal.Decimal]] = mapped_column(DECIMAL(5, 2), comment='涨跌幅（单位：%）')
    ...
    amplitude: Mapped[Optional[decimal.Decimal]] = mapped_column(DECIMAL(5, 2), comment='振幅（单位：%）')
    ...
    volume_ratio: Mapped[Optional[decimal.Decimal]] = mapped_column(DECIMAL(5, 2), comment='量比')
    turnover_rate: Mapped[Optional[decimal.Decimal]] = mapped_column(DECIMAL(5, 2), comment='换手率（单位：%）')
    ...
    increase_speed: Mapped[Optional[decimal.Decimal]] = mapped_column(DECIMAL(5, 2), comment='涨速')
    change_5min: Mapped[Optional[decimal.Decimal]] = mapped_column(DECIMAL(5, 2), comment='5分钟涨跌（单位：%）')
    change_60d: Mapped[Optional[decimal.Decimal]] = mapped_column(DECIMAL(5, 2), comment='60日涨跌幅（单位：%）')
    change_ytd: Mapped[Optional[decimal.Decimal]] = mapped_column(DECIMAL(5, 2), comment='年初至今涨跌幅（单位：%）')
